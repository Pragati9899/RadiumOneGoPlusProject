...
import io.appium.java_client.touch.offset.PointOption;
 ...
 public class BaseClass {
    ...
    protected void click(By by, By by2) {
        click((By) DriverManager.getDriver().findElement(by), (By) DriverManager.getDriver().findElement(by2));
    }
    ...
    protected void click(WebElement androideleement)  {
   ...
   /* protected void click(WebElement element) {
    ...
    protected void sendKeys(By by, By by2,String value) {
        sendKeys((By) DriverManager.getDriver().findElement(by), (By) DriverManager.getDriver().findElement(by2),value);
    }
    ...
    protected void sendKeys(WebElement androideleement,String value)  {
        if(DriverManager.getIsAndroid()) {
...
*/
    ...
    private void explicitlyWait(WebElement Element) {
    ...
    protected void tap(WebElement webelement) {
        ta=new TouchAction((PerformsTouchActions) DriverManager.getDriver());
	...
	protected void scollToSpecificElement(String text) {
        ...
        DriverManager.getDriver().findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\\\"\"+text+\"\\\").instance(0))")).click();
    ...
    protected boolean verifyElementIsChecked(By by){
        // TODO document why this method is empty
        return Boolean.parseBoolean(DriverManager.getDriver().findElement(by).getAttribute("checked"));
    }
     protected boolean verifyElementIsDisplayed(By by){
         // TODO document why this method is empty
         return Boolean.parseBoolean(DriverManager.getDriver().findElement(by).getAttribute("displayed"));
     }
}
